...
Scenario: User is able to update name of already created account
    Given Account registry is empty
    And I create an account using name: "nata", last name: "haydamaky", pesel: "95092909876"
    When I update "name" of account with pesel: "95092909876" to "sasha"
    Then Account with pesel "95092909876" has "name" equal to "sasha"

Scenario: Created account has all fields correctly set
    Given Account registry is empty
    And I create an account using name: "nata", last name: "haydamaky", pesel: "95092909876"
    Then Account with pesel "95092909876" has "name" equal to "nata"
    And Account with pesel "95092909876" has "surname" equal to "haydamaky"
